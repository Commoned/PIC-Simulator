...
namespace PIC_Simulator
{
    internal class Processor
    {
        ...
        {
            if (memory.memoryb1[0,register] == 0)
            {
                memory.memoryb1[0,Memory.STATUS] = (short)(memory.memoryb1[0,Memory.STATUS] + 0b_0000_0100);
            }
            else
            {
                ushort zeroflagmask = 0b_0000_0100;
                short zerostatus = (short)(memory.memoryb1[0,Memory.STATUS] & zeroflagmask);
        ...
        public void checkDigitCarryFlag(short register, short value, string funcType)
        {
            ...
            short regvalue = (short)(memory.memoryb1[0,register] & digitcarrymask);
            ...
            if(funcType == "add")
            {
                ...
                if (regvalue > 15)
                {
                    memory.memoryb1[0,Memory.STATUS] = (short)(memory.memoryb1[0,Memory.STATUS] + 0b_0000_0010);
                }
                else
                {
                    ushort digitcarryflagmask = 0b_0000_0010;
                    short digitcarrystatus = (short)(memory.memoryb1[0,Memory.STATUS] & digitcarryflagmask);
        ...
        public void checkCarryFlag(short register, string funcType)
        {
            ...
            short carrystatus = (short)(memory.memoryb1[0,Memory.STATUS] & carryflagmask);

            if (funcType == "add")
            {
                if ((short)(memory.memoryb1[0,register]) > 255 && carrystatus == 0b_0000_0000)
                {
                    memory.memoryb1[0,Memory.STATUS] = (short)(memory.memoryb1[0,Memory.STATUS] + 0b_0000_0001);
                }
                if ((short) (memory.memoryb1[0,register]) <=255 && carrystatus == 0b_0000_0001)
                {
                    memory.memoryb1[0,Memory.STATUS] = (short)(memory.memoryb1[0,Memory.STATUS] - 0b_0000_0001);
                }

                memory.memoryb1[0,register] = (short)(memory.memoryb1[0,register] & 0b_0000_0000_1111_1111);
            }
            
            if (funcType == "sub")
            {
                if ((short)(memory.memoryb1[0,register]) >= 0 && carrystatus == 0b_0000_0000)
                {
                    memory.memoryb1[0,Memory.STATUS] = (short)(memory.memoryb1[0,Memory.STATUS] + 0b_0000_0001);
                }
                if((short)(memory.memoryb1[0,register]) < 0 && carrystatus == 0b_0000_0001)
                {
                    memory.memoryb1[0,Memory.STATUS] = (short)(memory.memoryb1[0,Memory.STATUS] - 0b_0000_0001);
                }
            ...
            if (funcType == "rl")
            {
                short regcarry = (short)(memory.memoryb1[0,register] & 0b_0000_0001_0000_0000);
                short reglowbit = (short)(memory.memoryb1[0,register] & 0b_0000_0000_0000_0001);
                
                if(reglowbit == 0b_0000_0000_0000_0000 && carrystatus == 0b_0000_0001)
                {
                    memory.memoryb1[0,register] = (short)(memory.memoryb1[0,register] + 0b_0000_0001);
                }
        ...
        public short checkIndirect(short value)
        {
            ...
            {
                regval = memory.memoryb1[0,Memory.FSR];
        ...
        public void movwf(short value)
        {
            ...
            {
                memory.memoryb1[0,freg] = memory.memoryb1[0,Memory.W];
            }
        ...
        public void movf(short value)
        {
            ...
            memory.memoryb1[0,destreg] = memory.memoryb1[0,freg];
        ...
        public void addwf(short value)
        {
            ...
            checkDigitCarryFlag(destreg, memory.memoryb1[0,freg], "add");

            memory.memoryb1[0,destreg] = (short)(memory.memoryb1[0,Memory.W] + memory.memoryb1[0,freg]);
        ...
        public void subwf(short value)
        {
            ...
            checkDigitCarryFlag(Memory.W, memory.memoryb1[0,freg], "sub");

            short regvalue = (short)(memory.memoryb1[0,freg] - memory.memoryb1[0,Memory.W]);
            memory.memoryb1[0,destreg] = regvalue;
        ...
        {
            memory.memoryb1[0,Memory.W] = value;
            memory.memoryb1[0,Memory.PCL] = memory.pop();
            nop();
            memory.updateMemView();
        }
        ...
        {
            memory.push((short)(memory.memoryb1[0,Memory.PCL]));
            memory.Pcl = value;
            nop();
            memory.updateMemView();
        }
        ...
        public void clrf(short value)
        {
            ...
            memory.memoryb1[0,freg] = 0b_0000_0000;
        ...
        public void comf(short value)
        {
            ...
            memory.memoryb1[0,destreg] = (short)(0xFF - memory.memoryb1[0,freg]);
        ...
        public void decf(short value)
        {
            ...
            memory.memoryb1[0,destreg] = (short)((memory.memoryb1[0,freg] - 1) & 0b_0000_0000_1111_1111);
            checkZeroFlag(destreg);
            memory.updateMemView();
        }
        ...
        public void incf(short value)
        {
            ...
            memory.memoryb1[0,destreg] = (short)(memory.memoryb1[0,freg] + 1);
        ...
        public void swapf(short value)
        {
            ...
            short regvalue = memory.memoryb1[0,destreg];
            short lowerregvalue = (short) (regvalue & 0b_0000_1111);

            memory.memoryb1[0,destreg] = (short) ((regvalue >> 4) + (lowerregvalue << 4));
            memory.updateMemView();
        }
        ...
        public void rrf(short value)
        {
            ...
            short freg = (short)(value & 0b_0111_1111);
            short destvalue = (short)(value & 0b_1000_0000);
            short startingcarryvalue = (short)(memory.memoryb1[0,Memory.STATUS] & 0b_0000_0001);
            ...
            {
                memory.memoryb1[0,destreg] = (short)(memory.memoryb1[0,destreg] + 0b_1000_0000);
            }
        ...
        public void bsf(short instruction,short value)
        {
            ...
            {
                case 0:
                    memory.memoryb1[0,destreg] = (short)(memory.memoryb1[0,destreg] | 0b_01);
                    break;
                case 1:
                    memory.memoryb1[0,destreg] = (short)(memory.memoryb1[0,destreg] | 0b_010);
                    break;
                case 2:
                    memory.memoryb1[0,destreg] = (short)(memory.memoryb1[0,destreg] | 0b_100);
                    break;
                case 3:
                    memory.memoryb1[0,destreg] = (short)(memory.memoryb1[0,destreg] | 0b_1000);
                    break;
                case 4:
                    memory.memoryb1[0,destreg] = (short)(memory.memoryb1[0,destreg] | 0b_10000);
                    break;
                case 5:
                    memory.memoryb1[0,destreg] = (short)(memory.memoryb1[0,destreg] | 0b_100000);
                    break;
                case 6:
                    memory.memoryb1[0,destreg] = (short)(memory.memoryb1[0,destreg] | 0b_1000000);
                    break;
                case 7:
                    memory.memoryb1[0,destreg] = (short)(memory.memoryb1[0,destreg] | 0b_10000000);
                    break;
        ...
        public void bcf(short instruction, short value)
        {
            ...
            {
                case 0:
                    memory.memoryb1[0,destreg] = (short)(memory.memoryb1[0,destreg] & 0b_11111110);
                    break;
                case 1:
                    memory.memoryb1[0,destreg] = (short)(memory.memoryb1[0,destreg] & 0b_11111101);
                    break;
                case 2:
                    memory.memoryb1[0,destreg] = (short)(memory.memoryb1[0,destreg] & 0b_11111011);
                    break;
                case 3:
                    memory.memoryb1[0,destreg] = (short)(memory.memoryb1[0,destreg] & 0b_11110111);
                    break;
                case 4:
                    memory.memoryb1[0,destreg] = (short)(memory.memoryb1[0,destreg] & 0b_11101111);
                    break;
                case 5:
                    memory.memoryb1[0,destreg] = (short)(memory.memoryb1[0,destreg] & 0b_11011111);
                    break;
                case 6:
                    memory.memoryb1[0,destreg] = (short)(memory.memoryb1[0,destreg] & 0b_10111111);
                    break;
                case 7:
                    memory.memoryb1[0,destreg] = (short)(memory.memoryb1[0,destreg] & 0b_101111111);
                    break;
        ...
        public bool btfsc(short instruction, short value)
        {
            ...
            {
                case 0:
                   valtest = (short)(memory.memoryb1[0,destreg] & 0b_01);
                    break;
                case 1:
                    valtest = (short)(memory.memoryb1[0,destreg] & 0b_010);
                    break;
                case 2:
                    valtest = (short)(memory.memoryb1[0,destreg] & 0b_100);
                    break;
                case 3:
                    valtest = (short)(memory.memoryb1[0,destreg] & 0b_1000);
                    break;
                case 4:
                    valtest = (short)(memory.memoryb1[0,destreg] & 0b_10000);
                    break;
                case 5:
                    valtest = (short)(memory.memoryb1[0,destreg] & 0b_100000);
                    break;
                case 6:
                    valtest = (short)(memory.memoryb1[0,destreg] & 0b_1000000);
                    break;
                case 7:
                    valtest = (short)(memory.memoryb1[0,destreg] & 0b_10000000);
                    break;
            }
            if(valtest == 0)
            {
        ...
        public bool decfsz(short value)
        {
            ...
            if (memory.memoryb1[0,destreg] == 0)
            {
                return true;
            }
            else
        ...
        public bool incfsz(short value)
        {
            ...
            if((short)(memory.memoryb1[0,freg] + 1) <= 0b_1111_1111)
            {
                memory.memoryb1[0,destreg] = (short)(memory.memoryb1[0,freg] + 1);
            }
            if ((short)(memory.memoryb1[0,freg] + 1) > 0b_1111_1111)
            {
                memory.memoryb1[0,destreg] = (short)(0b_0000_0000);
            }
